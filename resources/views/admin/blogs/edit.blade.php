                ...
                <!-- Here it is if there is error in case on the signing a new user -->
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="title" value="{{ $blog->title }}" class="form-control validate" id="title" placeholder="Enter Title" required="">
                        </div>

                        <div class="form-group col-md-12">
                            <label for="slug">Slug</label>
                            <input type="text" name="slug" value="{{ $blog->slug }}" class="form-control validate" id="slug" placeholder="Enter Slug" required="">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" rows="5"  name="body">{{ $blog->body }}</textarea>
                        </div>
