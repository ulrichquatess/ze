                ...
                <!-- Here it is if there is error in case on the signing a new user -->
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="name" value="{{ $order->name }}" class="form-control validate" id="name" placeholder="Name Of Person Name" required="">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="phone" name="phone" value="{{ $order->phone }}" type="text" class="form-control validate" id="phone" placeholder="Enter Phone Number">
                        </div>


                        <div class="form-group col-md-6">
                            <label for="location">Location</label>
                            <input id="location" name="location" value="{{ $order->location }}" type="text" class="form-control validate" placeholder="Enter Location / Bonanjo">
                        </div>
