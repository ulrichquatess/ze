    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                {!! Form::open(['route' => 'admin.pages.store', 'data-parsley-validate' => '', 'files' => true]) !!}
                <!-- Here it is if there is error in case on the signing a new user -->
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input id="sub_title" name="sub_title" value="" type="text" class="form-control validate" id="sub_title" placeholder="Enter Subtitle">
                        </div>
