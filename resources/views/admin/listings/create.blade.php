    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                ...
                {!! Form::open(['route' => 'admin.listings.store', 'data-parsley-validate' => '', 'files' => true]) !!}
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="published">
                                <option value="0" {{ ($listing->published == false) || Request::old('published') == "0" ? 'selected' : '' }}>No</option>
                                <option value="1" {{ ($listing->published == true) || Request::old('published') == "1" ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
